package org.generation.demeterAPI.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.demeterAPI.controller"))
	...
	private static Contact contact() {
		return new Contact("Matheus Farina", "https://github.com/farinaceos", "farinamatheus07@gmail.com");
	}
